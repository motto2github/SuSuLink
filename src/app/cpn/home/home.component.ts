...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.commonLinkObjs = [
      ...
      , {id: '__ssl_commonLinkObj_2', title: 'Bootstrap 中文网', href: 'http://www.bootcss.com/', isStar: false, starCount: 8372628, desc: 'Bootstrap中文网 -- www.bootcss.com 创建于2012年。起因是国内没有较好的关于Bootstrap的中文教程和交流渠道，因此，我们对Bootstrap的文档进行了翻译整理，并且建立了QQ群和微博（<a href="http://weibo.com/bootcss" target="_blank">@bootcss</a>），方便更多热爱这个CSS框架的攻城师们分享、交流自己在前端设计、开发方面的心得。'}
